...
from app.api import auth, boundaries, layers, jobs, gee, analytics, corestack, raster_proxy, village_stories
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        from app.models import Job, CachedBoundary, VillageStory  # noqa: F401 — register models
